...
private DefaultTableModel tabmode;
    ...
    protected void datatable(){
        ...
        try {
            String sql = "SELECT * FROM barang where kd  like '%"+cariitem+"%' or nmbrg like '%"+cariitem+"%' order by kd asc";
    ...
    private void initComponents() {
        ...
        cbjenis.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Makanan", "Minuman", "Rokok", "Make Up", " " }));
    ...
    private void bubahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bubahActionPerformed
        ...
        //}
        try{
            String sql = "update barang set nmbrg=?,jenis=?,hargabeli=?,hargjualt=? where kd='"+txtkd.getText()+"'";
            PreparedStatement stat = conn.prepareStatement(sql);
